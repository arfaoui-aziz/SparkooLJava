...
User user;
    public void initData(User u, Reclamation rec) throws SQLException {
        ...
        sub.setText(rec.getType());
        cont.setText(rec.getMessage());
        rep.setText(rec.getReponse());
