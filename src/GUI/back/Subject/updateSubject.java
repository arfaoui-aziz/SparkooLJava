...
public class updateSubject {
    ...
    public void recupID(int id,String SubjectName,int Coefficient,String SubjectByClasse){
        idS = id;
        sName.setText(SubjectName);
        sCoefficient.setText(String.valueOf(Coefficient));
        sClasse.setValue(SubjectByClasse);
    }
    ...
    @FXML
    void gotoSubjects(MouseEvent event) {
